...
maryScore = input('What is your Mary Time?\n'
                 '20 Minute AMRAP\n'
                 '5 Handstand Pushups\n'
                 '10 Pistols\n'
                 '15 Pullups\n')
...
# pistol_reps = df_mary['movement'].loc[df_mary['reps_performed'] == 'pistols']
# pullup_reps = df_mary['movement'].loc[df_mary['reps_performed'] == 'pullups']
# hspu_reps = df_mary['movement'].loc[df_mary['reps_performed'] == 'handstand pushups']
...
# jackieTime = input('What is your Jackie Time?\n 1000m row \n 50 Thrusters @ 45)
